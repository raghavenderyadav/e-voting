...
echo "angular.module('e-voting.server-properties', []).constant('serverProperties', {\"serverUrl\": \"\/\", \"pathToApi\": \"nsd1/api\" });" > /home/ubuntu/e-voting/build/gui-public1/app/server-peroperties.js;
...
echo "angular.module('e-voting.server-properties', []).constant('serverProperties', {\"serverUrl\": \"\/\", \"pathToApi\": \"nsd2/api\" });" > /home/ubuntu/e-voting/build/gui-public2/app/server-peroperties.js;
